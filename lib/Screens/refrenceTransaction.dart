...
import 'package:tusharsonigames/model/ref_tran_model.dart';
import '../size_config.dart';
import 'package:dio/dio.dart' as dpack;

class RefrenceTransaction extends StatefulWidget {
  String? userid;

  RefrenceTransaction(this.userid);

  @override
  _RefrenceTransactionState createState() => _RefrenceTransactionState();
}

class _RefrenceTransactionState extends State<RefrenceTransaction> {
  List<TranRefrenceModel> maindata = [];
  ...
  getTransaction() async {
    if (!isLoading) {
      ...
      String url = 'http://www.aksdute.com/tsgames/get_refearn_tran.php';
          ...
          if (rowdata == null) {
            ...
            if (rowdata!.length <= 0) {
              ...
              for (var i in rowdata!) {
                maindata.add(TranRefrenceModel(
                    i['amount'], i['status'], i['bank_tran_id'],i['from_id'] ,i['date'],i['acc_name'],i['acc_no']));
              }
              setState(() {
                isLoading = false;
                dataloading = 1;
                        ...
                        ? Expanded(
                            child: ListView.builder(
                              ...
                              itemBuilder: (BuildContext context, int index) {
                                          ...
                                          Row(
                                            ...
                                            children: [
                                              Shimmer.fromColors(
                                                  ...
                                                  child: Icon(Icons.watch_later,size: 2.5*SizeConfig.heightMultiplier,)
                                              ),
                                              Container(
                                                margin: EdgeInsets.all(5),
                                                child: Gtext(
                                            ...
                                            children: [
                                              Container(
                                                ...
                                                child: Gtext(
                                                      ...
                                                      maindata[index].status!.capitalizeFirst!,
                                                  1.5,
                                                  color: Colors.black,
                                                  bold: true,
                                                ),
                                ...
                                } else if(maindata[index].status == 'credit') {
                                            ...
                                            children: [
                                              Shimmer.fromColors(
                                                  ...
                                                  child: Row(
                                                    mainAxisSize: MainAxisSize.min,
                                                    children: [
                                                      Icon(Icons.attach_money_sharp,size: 2.5*SizeConfig.heightMultiplier,),
