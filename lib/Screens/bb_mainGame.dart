...
class BB_MainGame extends StatefulWidget {

  String? type;
  int number_list;

  BB_MainGame(this.type, this.number_list);


  @override
  _BB_MainGameState createState() => _BB_MainGameState();
}

class _BB_MainGameState extends State<BB_MainGame> {
  ...
  getSelectedNumberList() async {
    ...
    dpack.FormData newData = new dpack.FormData.fromMap(
        {'userid': userid, 'g_type': widget.type});
                  ...
                  Row(
                    ...
                    children: [
                      ...
                      Container(
                          ...
                          ):Gtext('Insufficient\nBalance', 1.3,color: Colors.black,bold: true,)
                      ),
                    ],
                  ),
                  SizedBox(
