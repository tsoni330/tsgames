...
class _MoneyWithdrawState extends State<MoneyWithdraw> {
  String?  userid, local_device_id, name,acc_no,ifsc,type;
  late SharedPreferences prefs;
  String? added_money,acc_status;
  ...
  withdrawRequest(int amount) async {
    ...
    String url = 'http://www.aksdute.com/tsgames/add_withdraw_tran.php';
    ...
    await new dpack.Dio().post(url, data: newData).then((value) {
      if (value.statusCode == 200) {
        print('The response is '+jsonDecode(value.data).toString()+' status code '+value.statusCode.toString());
        if (value.data != null) {
                            ...
                            children: [
                              ...
                              Container(
                                  ...
                                  child: Gtext(
                                    ...
                                    " / "
                                    "हम सुबह 9 बजे से रात 9 बजे के बीच काम करते हैं। आपका अकाउंट एक बार अपडेट होने के बाद  आपका पैसा 30 मिनट से 1 "
